...
class Computer(models.Model):
	...
	size = models.CharField(default='15.6"', choices=SIZE_CHOICES.choices, max_length=10, blank=True, null=True)
	case = models.CharField(choices=CASE_CHOICES.choices, max_length=10, blank=True, null=True)
	resolution = models.CharField(default="1080P", choices=RESOLUTION_CHOICES.choices, max_length=10, blank=True, null=True)
	refresh_rate = models.CharField(default="60Hz", choices=REFRESHRATE_CHOICES.choices, max_length=10, blank=True, null=True)
	display = models.CharField(default="Ips",choices=DISPLAY_CHOICES.choices, max_length=10, blank=True, null=True)
...
class Smartphone(models.Model):
	...
	size = models.CharField(default='6.2"', choices=SIZE_CHOICES.choices, max_length=10, blank=True, null=True)
	resolution = models.CharField(default="1440P", choices=RESOLUTION_CHOICES.choices, max_length=10, blank=True, null=True)
	refresh_rate = models.CharField(default="90Hz", choices=REFRESHRATE_CHOICES.choices, max_length=10, blank=True, null=True)
	display = models.CharField(default="Ips", choices=DISPLAY_CHOICES.choices, max_length=10, blank=True, null=True)
